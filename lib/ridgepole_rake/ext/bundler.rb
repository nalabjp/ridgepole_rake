...
RidgepoleRake::Configuration.__send__(:prepend, RidgepoleRake::Ext::Bundler::Configuration)
RidgepoleRake::Command.__send__(:prepend, RidgepoleRake::Ext::Bundler::Command)
